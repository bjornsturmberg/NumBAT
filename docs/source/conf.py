...
MOCK_MODULES = ['scipy', 'scipy.interpolate', 'numpy',
    ...
    'fortran','make_axes_locatable']#,'csv', 'subprocess']
...
project = u'NumBAT'
copyright = u'2016-2017, Bjorn Sturmberg, Blair Morrison, Christopher Poulton and Michael Steel'
author = u'Bjorn Sturmberg, Blair Morrison, Christopher Poulton and Michael Steel'
...
u'Bjorn Sturmberg, Blair Morrison, \\\\ Christopher Poulton and Michael Steel' , 'manual'),
]
