...
It has also been successfully installed by users on Debian, RedHat and on Windows 10 (through lxwindows installation of linux) and with different versions of packages, but these installations have not been as thoroughly documented so may require user testing. 
