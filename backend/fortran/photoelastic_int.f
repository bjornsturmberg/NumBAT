...
C
     ...
     *  betas_EM, debug, overlap, basis_overlap_out)
c
      implicit none
...
C                 form e^{i*beta*z} phi.
                  ...
                  do ltest=1,nnodes0
                    do l_eq=1,3
                      ind_lp = l_eq + 3*(ltest-1)
C                       zt1 = phi2_list(itrial) * phi2_list(jtest)
              ...
              do jtest=1,nnodes0
                do j_eq=1,3
                  ...
                  do ltest=1,nnodes0
                    do l_eq=1,3
                      ind_lp = l_eq + 3*(ltest-1)
C                       Ustar = conjg(soln_AC(l_eq,ltest,ival3,iel))
                      Ustar = soln_AC(l_eq,ltest,ival3,iel)
                      do k_eq=1,3
                ...
                do j_eq=1,3
                  ...
                  do ltest=1,nnodes0
                    do l_eq=1,3
                      ind_lp = l_eq + 3*(ltest-1)
                      do ival3s = 1,nval_AC
C                         Ustar = conjg(soln_AC(l_eq,ltest,ival3s,iel))
                        Ustar = soln_AC(l_eq,ltest,ival3s,iel)
                        do k_eq=1,3
                          zt1 = basis_overlap(ind_ip,ind_jp,k_eq,ind_lp)
                          zt1 = E1star * E2 * Ustar * zt1
