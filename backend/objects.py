    ...
    def __init__(self, unitcell_x, inc_a_x,
        ...
        for k_typ in range(self.nb_typ_el_AC):
            if acoustic_props[k_typ]:
                ...
                eta_tensor[0,0,0,0,k_typ] = 0#acoustic_props[k_typ][7]
                eta_tensor[1,1,1,1,k_typ] = 0#acoustic_props[k_typ][7]
                eta_tensor[2,2,2,2,k_typ] = 0#acoustic_props[k_typ][7]
                eta_tensor[0,0,1,1,k_typ] = acoustic_props[k_typ][8]
                eta_tensor[0,0,2,2,k_typ] = 0#acoustic_props[k_typ][8]
                eta_tensor[1,1,0,0,k_typ] = 0#acoustic_props[k_typ][8]
                eta_tensor[1,1,2,2,k_typ] = 0#acoustic_props[k_typ][8]
                eta_tensor[2,2,0,0,k_typ] = 0#acoustic_props[k_typ][8]
                eta_tensor[2,2,1,1,k_typ] = 0#acoustic_props[k_typ][8]
                eta_tensor[1,2,1,2,k_typ] = 0#acoustic_props[k_typ][9]
                eta_tensor[1,2,2,1,k_typ] = 0#acoustic_props[k_typ][9]
                eta_tensor[2,1,1,2,k_typ] = 0#acoustic_props[k_typ][9]
                eta_tensor[2,1,2,1,k_typ] = 0#acoustic_props[k_typ][9]
                eta_tensor[0,2,0,2,k_typ] = 0#acoustic_props[k_typ][9]
                eta_tensor[0,2,2,0,k_typ] = 0#acoustic_props[k_typ][9]
                eta_tensor[2,0,0,2,k_typ] = 0#acoustic_props[k_typ][9]
                eta_tensor[2,0,2,0,k_typ] = 0#acoustic_props[k_typ][9]
                eta_tensor[0,1,0,1,k_typ] = 0#acoustic_props[k_typ][9]
                eta_tensor[0,1,1,0,k_typ] = 0#acoustic_props[k_typ][9]
                eta_tensor[1,0,0,1,k_typ] = 0#acoustic_props[k_typ][9]
                eta_tensor[1,0,1,0,k_typ] = 0#acoustic_props[k_typ][9]
        self.rho = rho
